    ...
    if (data.data_type == 'player')
    {
      ...
      console.log('Player has connected to the website!')
       ...
       { 
    		...
    		if (result == '')
		    {  
    			console.log('Player not found in the databas, adding player (?)',data.id);
